                ...
                <div className="w-[69.625rem] max-h-fit shadow-md mx-auto border border-[#C1C2C2] rounded-lg bg-white">
                    <div className="p-6">
                        ...
                        <div className="mt-6 flex">
                            <div
                                className="w-[20.5rem] h-[14rem] overflow-hidden rounded-sm mr-6 border border-gray-200">
                                <img
                                    src={roomImage}
                                    alt={roomName}
                            ...
                            <div className="flex-1">
                                <div className="flex gap-6 mb-4">
                                    <div
                                        className="rounded-[5px] border-[1px] border-[#858685] p-4 w-[6.5625rem] h-[6.625rem] text-center">
                                        <div
                                            className="text-[#858685] font-lato font-normal text-sm leading-[140%] tracking-normal align-middle">
                                            Check in
                                        </div>
                                        <div
                                            className="text-[#2F2F2F] font-lato font-bold text-base leading-[150%] tracking-normal align-middle">
                                            {checkInDate.day}
                                        </div>
                                        <div
                                            className="text-[#2F2F2F] font-lato font-normal text-base leading-[140%] tracking-normal align-middle">
                    ...
                    <div className="px-6">
                        ...
                        >
                            ...
                            <span
                                className=" text-[#2F2F2F] w-[15.9375rem] h-[2rem] flex flex-left font-lato font-bold text-base leading-[150%] tracking-normal">
                                Room total summary
                            </span>
                        </button>
                        ...
                        {isRoomSummaryOpen && (
                            <div className="ml-8.5">
                                <div className="flex justify-between py-1">
                                    <span
                                        className="text-[#5D5D5D] h-[1.4375rem] w-[17.3125rem] font-lato font-normal text-base leading-[140%] tracking-normal">
                                        Nightly rate
                                    </span>
                                    <span
                                        className="text-[#2F2F2F] font-lato font-normal text-xl leading-[140%] tracking-normal">
                                        {nightlyRate}
                                    </span>
                                </div>
                                <div className="flex justify-between py-1">
