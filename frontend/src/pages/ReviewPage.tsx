    ...
    return (
      <div className="min-h-screen bg-white p-4 md:p-8 flex flex-col items-center justify-center">
        <div className="max-w-3xl w-full bg-white rounded-lg shadow-md p-6 md:p-8">
          <h1 className="text-xl md:text-2xl font-semibold text-[#1C1C57] mb-6 text-center">Thank You for Your Review!</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-4 pt-4">
              <button
                ...
                className="text-[#4A4AFF] text-sm order-2 sm:order-1"
              >
              ...
              <button
                type="submit"
                disabled={rating === 0}
                className={`bg-[#1C1C57] text-white px-6 py-2 rounded text-sm order-1 sm:order-2 ${
