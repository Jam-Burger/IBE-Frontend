                            ...
                            >
                                <div className="p-6 relative z-10">
                                    ...
                                    <div className="text-gray-700 space-y-2 text-lg">
                                        <p>
                                            <span
                                                className="font-medium text-gray-900">{t('address')}:</span> {hotel.address}
                                        </p>
                                        <p>
                                            <span
                                                className="font-medium text-gray-900">{t('description')}:</span> {hotel.description}
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            ...
                                            <span
                                                className="text-green-600 font-semibold"> {convertPrice(hotel.pricePerNight)}</span>
                                        </p>
                                        <p>
                                            <span className="font-medium text-gray-900">{t('createdAt')}:</span>
                                            <span
                                                className="text-gray-600">{new Date(hotel.createdAt).toLocaleDateString()}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
