...
import {City, Country, State} from '../../services/LocationService';
...
const BillingInfoSection: React.FC<BillingInfoSectionProps> = ({
    ...
    const {handleInputChange: handleFormInputChange, handleSelectChange} = useCheckoutForm();
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                ...
                                <div className="flex-1">
                                    <Label htmlFor="city" className="text-sm mb-1 block">
                                        City{section.fields.find(f => f.label === 'City')?.required &&
                                    ...
                                    >
                                        ...
                                        >
                                            <SelectValue
                                                placeholder={!selectedCountryCode ? "Select country first" : "Choose"}/>
                                        </SelectTrigger>
                                        <SelectContent>
                                            {safeCities.length > 0 ? (
                                                safeCities.map((city) => (
                                                ...
                                                <div className="px-2 py-1 text-sm text-gray-500">No cities
                                                    available</div>
                                            )}
                                        </SelectContent>
                                    </Select>
                                ...
                                <div className="w-full md:w-1/3">
                                    <Label htmlFor="state" className="text-sm mb-1 block">
                                        State{section.fields.find(f => f.label === 'State')?.required &&
                                        <span className="text-red-500">*</span>}
                                    </Label>
                                    <Select
                                    ...
                                    >
                                        ...
                                        >
                                            <SelectValue
                                                placeholder={!selectedCountryCode ? "Select country first" : safeStates.length === 0 ? "Loading states..." : "Choose"}/>
                                        </SelectTrigger>
                                        <SelectContent>
                                            {safeStates.length > 0 ? (
                                ...
                                <div className="w-full md:w-1/4">
                                    <Label htmlFor="zip" className="text-sm mb-1 block">
                                        Zip{section.fields.find(f => f.label === 'Zip')?.required &&
                                        <span className="text-red-500">*</span>}
                                    </Label>
                                    <Input
                                        id="zip"
