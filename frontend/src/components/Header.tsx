...
const Header: React.FC = () => {
  ...
  return (
    <header className="relative flex justify-between items-center py-4 px-6 bg-white shadow-md">
      ...
      {/* Mobile Menu - Now positioned in the corner with limited width */}
      {mobileMenuOpen && (
        <div className="absolute top-full right-0 w-64 bg-white shadow-lg rounded-bl-md z-20 md:hidden">
          <div className="flex flex-col p-4 space-y-4">
            {/* My Bookings Link */}
            <a className="text-sm font-medium uppercase text-[#26266D] py-2 hover:bg-gray-50 rounded px-2">
              MY BOOKINGS
            </a>
            ...
            <div className="relative py-2">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-[#26266D] ml-2">{selectedLanguage.toUpperCase()}</span>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#26266D]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
