...
import { computeDiscountedPrice, generateSummeryText, toTitleCase } from '../lib/utils';
  ...
  return (
    <div className="bg-[#F5F5F5] p-6 w-[400px] h-[500px]">
      ...
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 mb-1">${formatCurrency(roomDetails.rate)}/night</p>
