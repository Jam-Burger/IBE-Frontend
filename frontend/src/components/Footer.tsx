    ...
    return (
        <footer className="bg-[#0d0524] text-white py-4 w-full">
            <div
                ...
                <span className="font-bold text-lg md:text-2xl flex items-center">{companyName.split(" ")[0]}</span>

                <div className="text-sm md:text-base mt-2 md:mt-0 md:text-right text-center">
